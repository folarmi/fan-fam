...
import { continents, countriesSample } from "@/app/data";
  ...
  return (
    <div>
      <div className="flex items-center py-[18px] bg-white border-b border-grey_20">
        <Image src={backArrow} alt="backArrow" className="mx-4 text-" />
        <p>Promote Profile</p>
      </div>
      ...
      <main className="mt-6 ml-3 md:ml-14">
        ...
        <section className=" border border-grey_20 py-2 mt-5">
          ...
          <div className="flex items-center justify-between px-4">
            ...
            <Image alt="arrowDown" src={arrowDown} className="w-5 h-5" />
          </div>
