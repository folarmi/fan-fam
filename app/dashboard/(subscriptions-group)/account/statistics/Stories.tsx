...
import StoryStatistics from "@/app/components/modals/StoryStatistics";
import {
  sampleEngagementTableData,
  sampleStreakData,
  statHeaderTwo,
} from "@/app/data";
import { statTimeLine } from "@/app/utils/helper";
              ...
              return (
                <section key={date}>
                  ...
                  <div className="flex items-center justify-between my-2">
                    <Image src={image} className="w-10 h-10" alt="sample" />
