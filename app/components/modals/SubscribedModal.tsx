...
import verifyTwo from "@/public/icons/verifyTwo.svg";
import tickSquare from "@/public/icons/tickSquare.svg";
import { subOptions } from "@/app/data";
    ...
    <div className="bg-white rounded-lg cursor-pointer">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mt-6">
          ...
          <Image alt="verifyTwo" src={verifyTwo} className="w-4 h-4" />
        </div>
