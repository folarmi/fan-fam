...
const CustomInput: React.FC<CustomInputProps> = ({
  ...
  return (
    <div className="relative flex flex-col gap-2 mb-6 w-full">
      ...
      <label
        htmlFor={name}
        className={`absolute left-4 top-2 text-sm font-medium text-gray-800 duration-300 transform -translate-y-4 scale-75 origin-[0] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-3 peer-focus:scale-75 peer-focus:-translate-y-7 ${
