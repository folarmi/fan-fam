  ...
  return (
    ...
    <div className="relative flex flex-col gap-2 mb-6 w-full">
      <input
        ...
        {...field}
        {...rest}
        className={`block w-full h-12 rounded-3xl px-4 text-sm bg-white border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-primary peer ${
